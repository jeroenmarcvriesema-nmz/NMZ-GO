...
export function StatCard({ label, value, variant = 'default' }: StatCardProps) {
  ...
  return (
    <div className="bg-white dark:bg-surface-dark-2 border border-gray-100 dark:border-white/10 rounded-lg shadow-sm p-5 relative overflow-hidden">
      ...
      <div className="text-xs text-gray-400 dark:text-white/40 font-medium mt-1.5">{label}</div>
    </div>
  )
}
