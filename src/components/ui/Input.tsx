  ...
  ({ label, error, hint, className, ...props }, ref) => (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ref={ref}
        className={cn(
          'w-full px-3.5 py-3 text-sm text-gray-900 bg-white border border-gray-200 rounded-sm outline-none transition-all placeholder:text-gray-400',
  ...
  ({ label, error, className, ...props }, ref) => (
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        ref={ref}
        className={cn(
          'w-full px-3.5 py-3 text-sm text-gray-900 bg-white border border-gray-200 rounded-sm outline-none transition-all resize-y',
          'focus:border-brand-yellow focus:ring-2 focus:ring-brand-yellow/20',
