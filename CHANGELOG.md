...
- **[FEATURE]** **Afgevinkte punten staan dichtgeklapt.** Elk afgerond punt nam de volle hoogte in met fotostrook, knoppen en het gesprekje eronder; bij zes punten waarvan drie af was de pagina bijna zevenduizend pixels lang, en een echte werkopdracht heeft er twintig tot dertig. Dicht blijft zichtbaar dát het punt af is en met welke foto's, in één regel met het aantal foto's erachter; aantikken klapt hem open.

  **Gemeten op een bon van 24 punten waarvan 18 af — de maat van een echte werkopdracht:** de puntenlijst gaat van 7.254 naar 3.473 pixels (**52% korter**), de hele pagina van 8.706 naar 4.924 (**43%**, van 10,3 naar 5,8 schermen). Voor kantoor, dat per punt ook nog beheerknoppen ziet: 10.262 naar 4.173 (**59%**). De besparing schaalt mee met hoeveel er al af is, en dat is precies waar hij nodig is — op een testbon van zes punten waarvan drie af is de winst een kwart.

  Een dichtgeklapt punt is bewust niet zo klein als het kon: de kop is minstens 44 pixels hoog, want dat is de enige manier om het punt weer open te krijgen en dan hoort het ook een echt aanraakvlak te zijn. Dat kost ongeveer drie procentpunt aan besparing, en dat is het waard.
